...
class editor extends CInputWidget
{
    ...
    public function init()
    {
        ...
        $cs->registerScriptFile($assetPrefix.'/ueditor.config.js');
        $cs->registerScriptFile($assetPrefix.'/ueditor.all.min.js');
        ...
        //else
        //{
            //$cs->registerScriptFile('http://ueditor.baidu.com/ueditor/ueditor.config.js');
        //    $cs->registerScriptFile('http://ueditor.baidu.com/ueditor/ueditor.all.min.js');
        //}
